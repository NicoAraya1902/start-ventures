...
DROP FUNCTION IF EXISTS public.get_connected_profile_details(uuid);

-- Create discovery function with new area fields
...
-- Create connected profile details function with new area fields
